...
function todoMain(){
    ...
    function getElements(){
        ...
        //11
        dateInput = document.getElementById("dateInput"); // 修正
        timeInput = document.getElementById("timeInput"); // 修正
...
//        console.log(dateObj.toLocaleString("zh-TW"));
//        console.log(dateObj.toLocaleString("en-US"));
//        console.log(dateObj.toLocaleString("en-GB"));
