...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    /* FullCalendar-specific DOM Utilities = FullCalendar 特定的 DOM 實用程序
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    /* String Utilities = 字符串實用程序
    ----------------------------------------------------------------------------------------------------------------------*/
    function padStart(val, len) {
        var s = String(val);
        return '000'.substr(0, len - s.length) + s;
    }
    /* Number Utilities = 數字實用程序
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    /* FC-specific DOM dimension stuff = FC 特定的 DOM 維度內容
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    // start-of-first-week - start-of-year = 第一周開始 - 年初
    function firstWeekOffset(year, dow, doy) {
        // first-week day -- which january is always in the first week (4 for iso, 1 for other)
        // 第一周的某一天 -- 哪一月總是在第一周（iso 為 4，其他為 1）
        var fwd = 7 + dow - doy;
        // first-week day local weekday -- which local weekday is fwd
        // 本地工作日的第一周 -- 哪個本地工作日是 fwd
    ...
    function arrayToUtcDate(a) {
        ...
        // 根據網絡標準（和 Safari），需要月份索引。
        // massage if only given a year. = 訊息如果只給予一年。
        if (a.length === 1) {
            a = a.concat([0]);
        }
    ...
    */
    ...
    // spans from one day into another? 從一天跨越到另一天？
